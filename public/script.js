...
function updatePaddles() {
  if (wPressed && paddleL.y > 5) {
    paddleL.y -= 6;
  } else if (sPressed && paddleL.y + paddleL.height < canvas.height - 5) {
    paddleL.y += 6;
  }
  if (upPressed && paddleR.y > 5) {
    paddleR.y -= 6;
  } else if (downPressed && paddleR.y + paddleR.height < canvas.height - 5) {
    paddleR.y += 6;
  }
}
